...
const translations: Record<string, string> = {
  ...
  "El objetivo era transformar los guiones de Dune en datos estructurados y representarlos mediante distintas visualizaciones comprensibles y creativas, haciendo visibles las relaciones, apariciones y curiosidades de sus personajes.": "The objective was to transform the Dune screenplays into structured data and represent it through a range of clear, creative visualisations, revealing the characters' relationships, appearances and other interesting details.",
  "La propuesta combina el análisis computacional con el diseño para ofrecer una nueva forma de explorar su universo narrativo. Entre las diferentes gráficas, destaca un diagrama de cuerdas (chord diagram) cuya composición circular imita la característica forma de la boca de un gusano de arena y conecta las relaciones entre personajes con uno de los elementos más reconocibles de la saga.": "The project combines computational analysis and design to offer a new way of exploring its narrative universe. Among the different charts, a chord diagram stands out: its circular composition echoes the distinctive shape of a sandworm's mouth, connecting the relationships between characters with one of the saga's most recognisable elements.",
