    ...
    <>
      ...
      <main className="relative min-h-screen flex flex-col items-center overflow-hidden">
        ...
        <div className="block md:hidden px-4">
          <h2 className="text-[36px] text-black font-bold mb-12 text-center">SERVICIOS</h2>
        ...
        <div className="w-full px-[20px] md:px-[50px] lg:px-[80px] xl:px-[120px] mt-[100px] mb-[60px]">
          <div className="max-w-[1200px] pr-[20px] md:pr-[215px]">
            <ScrollReveal textClassName="text-black text-[34px] md:text-[clamp(1.6rem,4vw,3rem)] lg:text-[clamp(2rem,4.5vw,3.5rem)] xl:text-[clamp(2.2rem,5vw,4rem)] font-bold text-left leading-snug">
              Trabajos destacados
            </ScrollReveal>
          </div>
        </div>
      ...
      <div ref={carouselRef} className="hidden md:block">
        <HorizontalScrollGallery itemCount={3}>
          <div className="relative w-screen h-full flex-shrink-0 flex items-center justify-center" style={{ paddingRight: '32px' }}>
            <div
              ...
              className="w-[1200px] h-[700px] lg:w-[75vw] lg:h-[45vw] xl:w-[70vw] xl:h-[40vw] max-w-[1400px] max-h-[800px]"
              style={{
                borderRadius: '50px',
                overflow: 'hidden',
