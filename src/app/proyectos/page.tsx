...
export default function ProyectosPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Header Section */}
            <div className="pt-32 pb-16 px-8 max-w-6xl mx-auto xl-reduced-project-margins xxl-reduced-project-margins">
                <div className="mb-16">
                    <MaskedHeading
                        text="PROYECTOS"
                ...
                <div ref={projectsGridRef} className="mb-20 xl-large-project-media xxl-large-project-media">
                    <FocusCards
