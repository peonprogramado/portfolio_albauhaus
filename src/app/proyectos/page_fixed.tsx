...
export default function ProyectosPage() {
                ...
                projectElements.forEach((project, index) => {
                    ...
                    if (innerElements.length > 0) {
                        gsap.set(innerElements, {
                            opacity: 0,
                            scale: 0.8,
                            filter: "blur(2px)", // Blur muy ligero para elementos internos
                            rotation: 0
                        });
                    }
                });
                ...
                projectElements.forEach((project, index) => {
                    ...
                    if (innerElements.length > 0) {
                        ...
                        testTimeline.to(innerElements, {
                            ...
                            ease: "power2.out",
                            stagger: 0.1
                        }, index * 0.4 + 0.3); // Al mismo tiempo que la animación de elementos internos
                    }
                });
            }
        }, 100);
    ...
    }, [filteredProjects]); // Dependencia en filteredProjects para re-animar cuando cambie el filtro
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="pt-32 pb-16 px-8 max-w-6xl mx-auto">
                <div className="mb-16">
                    <h1 className="text-[80px] md:text-[120px] font-bold text-black leading-none mb-4">
                        PROYECTOS
                    </h1>
                    <p className="text-xl md:text-2xl text-black max-w-2xl leading-relaxed">
                        A multidisciplinary creative blending motion design, 3D art.
                    </p>
                </div>
                ...
                <div className="mb-12 relative inline-block">
                    ...
                    <button
                        ...
                        className="bg-white/10 backdrop-blur-md border-2 border-black/20 rounded-full px-6 py-3 text-black font-medium focus:outline-none hover:bg-white/20 transition-colors cursor-pointer flex items-center justify-between w-auto min-w-[220px] gap-4"
                    >
                    ...
                    {isDropdownOpen && (
                        <div className="absolute top-0 left-0 w-full bg-white/10 backdrop-blur-md border-2 border-black/20 rounded-2xl shadow-lg z-40 overflow-hidden">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    ...
                                    {project.id === 4 && (
                                        <div className="relative">
                                            <div className="project-inner-element w-32 h-32 border-2 border-black rounded-full"></div>
                                            <div className="project-inner-element absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-black rounded-full"></div>
                                            <div className="project-inner-element absolute -top-4 -left-4 w-40 h-40 border border-black rounded-full opacity-50"></div>
                                        </div>
                                    )}
                                    {project.id === 5 && (
                                        <div className="project-inner-element text-black text-2xl font-semibold flex items-center">
                                            <span className="project-inner-element mr-3">⚡</span>
                                            <span className="project-inner-element">Nucleate</span>
                                        </div>
                                    )}
                                </div>
                            </div>
