        ...
        <footer ref={footerRef} className="w-full bg-black text-white mt-40 pb-16 pt-20">
            <div className="w-full max-w-[1200px] mx-auto px-8 xl-reduced-project-margins xxl-reduced-project-margins">
                ...
                <div className="hidden md:block">
                    ...
                    <div className="flex items-center justify-start gap-6 md:gap-8 mb-12 xl-large-project-media xxl-large-project-media">
                        <h2 className="text-[96px] leading-none font-bold tracking-tight">
                            <VariableProximity
                                label="TRABAJEMOS JUNTOS"
                                fromFontVariationSettings="'wght' 400, 'wdth' 100"
                                toFontVariationSettings="'wght' 900, 'wdth' 150"
                    ...
                    <div className="flex flex-wrap justify-start gap-3 mb-12 mt-[100px] xl-project-text-separation xxl-project-text-separation">
                        {socials.map((item) => (
                            <a
                                key={item.label}
                                href={item.href}
