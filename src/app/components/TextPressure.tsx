...
const TextPressure: React.FC<TextPressureProps> = ({
    ...
    // Preload de fuente y limpieza de referencias
    useEffect(() => {
        spansRef.current = [];
    ...
    const setSize = () => {
        ...
        // Usar setTimeout en lugar de requestAnimationFrame para dar tiempo a la fuente
        setTimeout(() => {
    ...
    }, [width, weight, italic, alpha, chars.length, fontLoaded, isInitialized]);

    // Mostrar loading state mientras carga la fuente
    if (!fontLoaded) {
        return (
            <div
                ref={containerRef}
